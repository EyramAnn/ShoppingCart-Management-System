...
// Functions to check maximum capacity 
function addItemToCart() {
  ...
  if (cart.length >= maxCapacity) {
    displayMessage("Cart is at maximum capacity.That's all for the day", "error");
    return;
  }
...
function removeItemFromCart() {
  if (cart.length === 0) {
    displayMessage("Cart is empty. You can't remove item", "error");
    return;
  }
...
// Function to update free shipping status
function updateCart() {
